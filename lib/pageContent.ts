...
export const ABOUT_PAGE: AboutPageContent = {
  ...
  hero: {
    ...
    imageUrl: '/images/web/about-hero.png',
  ...
  profileImageUrl: '/images/web/doctor-suit.jpg',
  ...
  interestImageUrl: '/images/web/robe-window.jpg',
...
export const HOME_PAGE: HomePageContent = {
  ...
  heroImageUrl: '/images/web/hero-2.jpg',
  ...
  philImageUrl: '/images/web/doctor-suit.jpg',
  ...
  aboutImageUrl: '/images/web/consultation.jpg',
