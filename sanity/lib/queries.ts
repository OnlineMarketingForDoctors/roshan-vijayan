...
export const procedureQuery = groq`*[_type=="procedure" && slug.current==$slug][0]{
  ...
  showCandidates, showProcedure, showJourney, showRisks, showSurgeon, showWhy,
  showCost, showFaqs, showRelated,
  ...
  benefitsHeading, benefitsIntro, benefitsList, benefitsImage,
  candidatesHeading, candidatesIntro, candidates, candidatesOutro, candidatesImage,
